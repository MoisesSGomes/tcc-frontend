...
function SearchFilter() {
    ...
    async function loadEvents(currentPage, searchQuery) {
        try {
            const { data: { events, totalPages } } = await api.get(`/buscar-eventos?page=${currentPage}&search=${encodeURIComponent(searchQuery)}`)
            setAllEvents(events)
